import { z } from 'zod';
import { invokeModel, isTransientError, mapWithConcurrency } from '../data/datasources/bedrock.js';
import { config } from '../shared/config.js';
import { renderTemplate } from './bedrockService.js';
import {
  type Certification,
  type ConceptPlan,
...
async function invokePlannerOnce(
  ...
  return invokeModel({ modelId: config.bedrockModelDefault, text: prompt });
}
